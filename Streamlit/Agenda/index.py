...
from templates.manterlogin import Manterlogin
...
class IndexUI:
    ...
    def sidebar():
      op = st.sidebar.selectbox("Menu", ["Manter Clientes", "Manter Serviços", "Manter Agenda", "Abrir Agenda do Dia","Cadrastre-se"])
      ...
      if op == "Cadrastre-se": Manterlogin.main()
